...
public class LombokTest {
	...
	public static void main(String[] args) {
		...
		/*
 				INFO  com.xiaokey.test.pojoTest.Student - id:1,姓名:xuwujing,班级:1
				INFO  com.xiaokey.test.pojoTest.Student - 学生信息:Student(name=zhangsan)
				成功创建！
				成功创建！
				xuwujing
				出现了空指针！
				java.lang.NullPointerException: name is marked @NonNull but is null
				at com.xiaokey.test.pojoTest.Student.test4(Student.java:143)
				at com.xiaokey.test.pojoTest.Student.main(Student.java:81)
		 */
